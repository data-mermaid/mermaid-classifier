...
class TrainingDataset:
    ...
    def __init__(self, options: DatasetOptions):
        ...
        # Recover the original (bucket, S3 key) for each filesystem-backed
        # feature_loc so add_training_set_names can JOIN against the
        # annotations table, which still holds S3-style keys.
        self.feature_loc_to_s3_key: dict[
            DataLocation, tuple[str, str]
        ] = {}
    ...
    def prep_annotations_for_pyspacer(self):
        ...
        for (bucket, feature_bucket_path, site, project_id,
            ...
            self.feature_loc_to_s3_key[feature_loc] = (
